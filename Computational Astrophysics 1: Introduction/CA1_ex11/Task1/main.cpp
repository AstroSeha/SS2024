...
int main() {
    ...
    scatter(neutrons_count, pc, ps, f, t, captured, reflected, transmitted, x_positions, captured_flags, reflected_flags, transmitted_flags);
    ...
    draw(neutrons_count, x_positions, captured_flags, reflected_flags, transmitted_flags, pc, ps, f, t, fc, fr, ft);
