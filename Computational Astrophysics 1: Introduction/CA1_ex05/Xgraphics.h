...
extern Display         *meindisplay;
extern int             meinscreen;
extern Window          meinwindow;
extern World           meinworld;
extern unsigned long   black,white,global_color;
extern int             global_function;
extern GC              meingc,cleargc,initgc;
extern XEvent          meinevent;
extern XSetWindowAttributes attributes;
extern int             buttonflag;
extern ButtonList      buttonlist;
extern unsigned long   meincolors[MAX_COLORS];
extern int             NofColors;
extern Colormap        meincmap;
...
Window  CreateWindow(
		     ...
		     const char *sname              /* window title, changed to const: H.Todt 28.04.2016          */
		     );
/* 
